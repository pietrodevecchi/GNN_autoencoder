...
def filter_adj(
    ...
    edge_index_map: Optional[Tensor] = None,
    ...
    if edge_index_map is not None:
        edge_index_map = edge_index_map[mask]

    return torch.stack([row, col], dim=0), edge_attr, edge_index_map
...
class FilterEdges(Connect):
    ...
    def forward(
        ...
        edge_index, edge_attr, edge_index_map = filter_adj(
            edge_index,
            edge_attr,
        ...
        return ConnectOutput(edge_index, edge_attr, batch), edge_index_map
